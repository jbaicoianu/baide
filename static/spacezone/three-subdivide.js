(function() {
    ...
    const _average = new THREE__namespace.Vector3();
    const _center = new THREE__namespace.Vector3();
    const _midpoint = new THREE__namespace.Vector3();
    const _normal = new THREE__namespace.Vector3();
    const _temp = new THREE__namespace.Vector3();

    const _vector0 = new THREE__namespace.Vector3(); // .Vector4();
    const _vector1 = new THREE__namespace.Vector3(); // .Vector4();
    const _vector2 = new THREE__namespace.Vector3(); // .Vector4();
    const _vec0to1 = new THREE__namespace.Vector3();
    const _vec1to2 = new THREE__namespace.Vector3();
    const _vec2to0 = new THREE__namespace.Vector3();
    ...
    const _triangle = new THREE__namespace.Triangle();
    ...
    class LoopSubdivision {
        ...
        static edgeSplit(geometry) {
            ...
            const split = new THREE__namespace.BufferGeometry();
        ...
        static flat(geometry, params = {}) {
            ...
            if (! verifyGeometry(geometry)) return geometry;
            const existing = (geometry.index !== null) ? geometry.toNonIndexed() : geometry.clone();
            const loop = new THREE__namespace.BufferGeometry();
        ...
        static smooth(geometry, params = {}) {
            ...
            attributeList.forEach((attributeName) => {
                ...
                loop.setAttribute(attributeName, new THREE__namespace.BufferAttribute(floatArray, flattenedAttribute.itemSize));
            });
            ...
            for (const attributeName in morphAttributes) {
                ...
                for (let i = 0, l = morphAttribute.length; i < l; i++) {
                    ...
                    const floatArray = subdivideAttribute(attributeName, existingAttribute, flattenedAttribute);
                    array.push(new THREE__namespace.BufferAttribute(floatArray, flattenedAttribute.itemSize));
                }
                loop.morphAttributes[attributeName] = array;
            }
            loop.morphTargetsRelative = existing.morphTargetsRelative;
