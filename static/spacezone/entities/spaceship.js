...
*/
    ...
    this.pitchFilter = new this.KalmanFilter(0.4, 0.1);
    this.rollFilter = new this.KalmanFilter(0.4, 0.1);
    this.offsetXFilter = new this.KalmanFilter(0.4, 0.1);
    this.offsetYFilter = new this.KalmanFilter(0.4, 0.1);
