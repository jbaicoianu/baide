// Modified version of https://www.shadertoy.com/view/XtBXDw

#define SHADERTOY

/**** TWEAK *****************************************************************/
#define COVERAGE		0.40
#define THICKNESS		8.
...
#define FAKE_LIGHT
#define SUN_DIR			normalize(vec3(0.,1.,-1.)) * 0.5
//normalize(vec3(0, abs(sin(u_time * .3)), -1))
...
void mainImage(
	...
	vec2 aspect_ratio = vec2(2. / 1., 1);
	float fov = tan(radians(89.99));
